...
class DetailViewFactory {
    static func getDetailView(type: DevMenuItemType, contextProvider: DevMenuPresentationContextProvider) -> AnyView {
        switch type {
        ...
        case .reportIssue:
            return AnyView(IssueReporter(contextProvider: contextProvider))
        }
    }
